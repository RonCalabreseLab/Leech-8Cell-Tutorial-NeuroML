...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 8, 2);
 	...
 	ivoc_help("help ?1 pulseGen1 /Users/johnrosejr/Documents/Emory Workspace/leech_tutorial_neuroml/Examples/x86_64/pulseGen1.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=pulseGen1 type=pulseGenerator)";
