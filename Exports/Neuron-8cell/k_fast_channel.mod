...
PROCEDURE rates() {
    ...
    m_timeCourse_t = (1.5 + (8.0 / 1 + exp(0 - (v + 0.022* m_timeCourse_VOLT )/ m_timeCourse_scale )) + (-2.2 / ((exp( m_timeCourse_v_cosh ) + exp(0 -  m_timeCourse_v_cosh )) / 2)))* m_timeCourse_SEC ? evaluable
